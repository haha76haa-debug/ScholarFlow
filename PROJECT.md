...
- **Frontmatter**:
  ...
  - `primary_sources`: list of wikilinks `[[Sources/Papers/he2016deep]]`
...
│   │   └── comparison_schema.yaml     # Comparison note schema contract
...
│   └── comparison_template.md         # Comparison note template
├── Sources/
│   └── Papers/                        # Literature notes (Demo examples)
│       ├── he2016deep.md
...
│   ├── Comparisons/                   # Domain comparison cards (Optional)
