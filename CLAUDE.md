# CLAUDE.md — Autonomous Academic Knowledge Base Operating Constitution

This document defines the authoritative operating protocols, architecture, interface contracts, and lifecycle workflows for Claude Code / LLM Agents operating within the **Zotero-Obsidian Academic Knowledge Base System**.
